  ...
  return (
    <div className="bg-white pb-4 px-4 rounded-md w-full">
      <div className="flex justify-between w-full pt-6 ">
        <p className="font-bold text-indigo-700">Payments History</p>
        <Button
          width="w-200"
          padding={3}
          border=""
      ...
      <div className="w-full flex justify-end px-2 mt-2">
        <div className="w-full sm:w-64 inline-block relative ">
          <input
            type="text"
            name="search"
            className="leading-snug border border-indigo-300 block w-full appearance-none bg-indigo-100 text-sm text-indigo-600 py-1 px-4 pl-8 rounded-lg"
            placeholder="Search"
          />

          <div className="pointer-events-none absolute pl-3 inset-y-0 left-0 flex items-center px-2 text-indigo-300">
            <svg
      ...
      <div className="overflow-x-auto mt-6">
        <table className="table-auto border border-indigo-100 w-full ">
          <thead>
            <tr
              className="rounded-lg text-sm font-medium text-left bg-indigo-600"
              style={{ fontSize: "0.9674rem" }}
            >
              <th className="px-4 py-4 text-white ">Flight ID</th>
              <th className="px-4 py-4 text-white ">Flight Time</th>
              <th className="px-4 py-4 text-white ">Origin</th>
              <th className="px-4 py-4 text-white ">Destination</th>
              <th className="px-4 py-4 text-white ">Amount</th>
              <th className="px-4 py-4 text-white ">Payment ID</th>
              <th className="px-4 py-4 text-white ">Verified</th>
            </tr>
          </thead>
          <tbody className="text-sm font-normal text-gray-700">
            <PaymentRow is_verified />
            <PaymentRow is_verified />
            <PaymentRow />
            <PaymentRow is_verified />
            <PaymentRow is_verified />
